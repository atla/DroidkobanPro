...
public class TronTheme implements Theme {
	...
	public TronTheme(GL10 gl, AssetManager am) {

		Log.v("DefaultTheme", "CONSTRUCTOR CALLED");
	...
	public void load(GL10 gl, AssetManager am) {
		...
		this.boxRenderer = new Cube(gl, 0.8f, am, "textures/psych/wood.png");
		this.groundRenderer = new Quad(gl, 1.0f, am, "textures/psych/floor.png");
		this.stoneRenderer = new Cube(gl, 0.5f, am, "textures/psych/stone.png");
		this.targetRenderer = new Quad(gl, 1.0f, am, "textures/psych/target.png");
