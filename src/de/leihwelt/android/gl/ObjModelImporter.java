...
public class ObjModelImporter {
	...
	public static String getMeshString(InputStream in) {
		String line = "";
	...
	public static GLMesh loadObj(GL10 gl, InputStream in) {
		String line = "";
	...
	public static GLMesh loadObj(GL10 gl, String data) {
		return loadObjFromString(gl, data);
	}
	 ...
	 * @return The Mesh
	 */
	public static GLMesh loadObjFromString(GL10 gl, String obj) {
		...
		GLMesh mesh = new GLMesh(gl, numFaces * 3, false, numUV > 0, numNormals > 0);
